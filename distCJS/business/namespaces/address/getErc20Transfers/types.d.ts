...
export type TGetErc20TransfersResponseRaw = Omit<PaginatedResponseRaw<TErc20TransferRaw>, "count">;
export type TGetErc20TransfersResponse = Omit<PaginatedResponse<TErc20Transfer>, "count">;
export type TGetErc20Transfers = (request: TGetErc20TransfersRequest) => Promise<TGetErc20TransfersResponse>;
