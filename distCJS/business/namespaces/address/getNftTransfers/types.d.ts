...
export type TGetNftTransfersResponseRaw = Omit<PaginatedResponseRaw<TNftTransferRaw>, "count">;
export type TGetNftTransfersResponse = Omit<PaginatedResponse<TNftTransfer>, "count">;
export type TGetNftTransfers = (request: TGetNftTransfersRequest) => Promise<TGetNftTransfersResponse>;
