...
export type TGetTransactionsResponseRaw = Omit<PaginatedResponseRaw<TTransactionRaw>, "count">;
export type TGetTransactionsResponse = Omit<PaginatedResponse<TTransaction>, "count">;
export type TGetTransactions = (request: TGetTransactionsRequest) => Promise<TGetTransactionsResponse>;
