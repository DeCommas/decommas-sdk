...
export type TGetNftTransfersByTxResponseRaw = Omit<PaginatedResponseRaw<TNftTransferByTxRaw>, "count">;
export type TGetNftTransfersByTxResponse = Omit<PaginatedResponse<TNftTransferByTx>, "count">;
export type TGetNftTransfersByTx = (request: TGetNftTransfersByTxRequest) => Promise<TGetNftTransfersByTxResponse>;
