...
exports.mockNftTransfersResponse = exports.mockNftTransfersResponseRaw = void 0;
const chains_1 = require("../../lib/chains");
exports.mockNftTransfersResponseRaw = {
    status: 200,
    result: [
        {
            ...
            amount: "1",
            transaction_hash: "0xd56e8d4d606499f0e2001d9d04ea5d79ba668ef24ab58c529e97f36e3ddbffe7",
            method: "mintBatch",
            method_hash: "0x927f59ba",
        },
    ],
};
exports.mockNftTransfersResponse = {
    result: [
        {
            ...
            amount: "1",
            transactionHash: "0xd56e8d4d606499f0e2001d9d04ea5d79ba668ef24ab58c529e97f36e3ddbffe7",
            method: "mintBatch",
