...
exports.mockNftTransfersByTxResponse = exports.mockNftTransfersByTxResponseRaw = void 0;
exports.mockNftTransfersByTxResponseRaw = {
    status: 200,
    result: [
        {
...
exports.mockNftTransfersByTxResponse = {
    result: [
        {
